...
export const MYTHOS_SKILL_CATEGORIES = [
  {
    ...
    label: 'CongChain',
    count: 24,
    summary: 'Official and bridge-ready skills for verifiable memory, audit, Solana, Web3, deployment, and operators.',
  },
  {
    id: 'development',
    label: 'Dev',
...
export const MYTHOS_RUNTIME_PROOF = {
  ...
  installedCongChainSkills: 22,
  localSkillsEnabled: 25,
  totalRuntimeSkillsEnabled: 99,
  memoryState: {
    write: 'passed',
    read: 'passed',
    verify: 'exists',
...
export const MYTHOS_FEATURED_SKILLS = [
  ...
  },
  {
    ...
    category: 'congchain',
    path: 'skills/congchain/solana-developer',
    status: 'runtime ready',
    level: 'official',
    useCase:
      'Build, review, and debug Solana apps, Anchor programs, PDAs, SPL token flows, and wallet integrations with read-only safety boundaries.',
    bestFor: 'Use when Mythos is acting as a Solana development copilot or reviewing a program/debug report.',
    command: 'mythos skill use skills/congchain/solana-developer',
  },
  {
    id: 'congchain-analyst',
    name: 'CongChain Analyst',
    category: 'congchain',
    path: 'skills/congchain/congchain-analyst',
    status: 'audit ready',
    level: 'official',
    useCase:
      'Analyze CongChain memory records, hashes, proofs, vault metadata, and agent activity without overstating on-chain finality.',
    bestFor: 'Use when an operator wants a clean memory/proof/vault report.',
    command: 'mythos skill use skills/congchain/congchain-analyst',
  },
  {
    id: 'web3-researcher',
    name: 'Web3 Researcher',
    category: 'congchain',
    path: 'skills/congchain/web3-researcher',
    status: 'research ready',
    level: 'official',
    useCase:
      'Research Solana/Web3 projects with source discipline, tokenomics review, risk labels, and CongChain-ready summaries.',
    bestFor: 'Use for project due diligence, ecosystem research, or market intelligence without financial advice.',
    command: 'mythos skill use skills/congchain/web3-researcher',
  },
  {
    id: 'mythos-deployer',
    name: 'Mythos Deployer',
    category: 'congchain',
    path: 'skills/congchain/mythos-deployer',
    status: 'ops ready',
    level: 'official',
    useCase:
      'Plan and verify Mythos runtime deployment across local, Docker, VPS, Fly.io, Railway, and secured gateway environments.',
    bestFor: 'Use when configuring providers, gateway tokens, deployment checks, or runtime health.',
    command: 'mythos skill use skills/congchain/mythos-deployer',
  },
  {
    id: 'agent-architect',
    name: 'Agent Architect',
    category: 'congchain',
    path: 'skills/congchain/agent-architect',
    status: 'orchestration ready',
    level: 'official',
    useCase:
      'Design multi-agent Mythos systems with delegation, skills, memory boundaries, governance, and CongChain shared context.',
    bestFor: 'Use when Mythos coordinates specialist agents, pipelines, review loops, or shared memory handoffs.',
    command: 'mythos skill use skills/congchain/agent-architect',
  },
  {
    id: 'pt-br-operator',
    name: 'PT-BR Operator',
    category: 'congchain',
    path: 'skills/congchain/pt-br-operator',
    status: 'operator ready',
    level: 'official',
    useCase:
      'Communicate with Brazilian Portuguese users using local formatting, precise setup guidance, and CongChain safety boundaries.',
    bestFor: 'Use when the user writes in Portuguese or needs Brazil-local operator instructions.',
    command: 'mythos skill use skills/congchain/pt-br-operator',
  },
  {
