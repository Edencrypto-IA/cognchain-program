      ...
      >
        <div className="flex flex-col h-full w-[280px] min-w-[280px]">
          ...
          <div className="p-3 border-t border-white/[0.06]">
            {isAdmin ? (
              <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-[#9945FF]/8 border border-[#9945FF]/15">
              ...
              <a href="/login"
                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl bg-white/[0.025] border border-white/[0.05] hover:bg-white/[0.05] hover:border-[#9945FF]/25 transition-all group">
