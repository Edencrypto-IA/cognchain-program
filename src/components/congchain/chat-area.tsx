...
function formatWalletAgentNotificationChatMessage(
  ...
  const emailNote = draft.channels.includes('email')
    ? draft.emailVerifiedLocally && draft.emailAddress
      ? `- Email: preparado para ${draft.emailAddress}${draft.emailSource === 'cog_user' ? draft.emailSessionVerified ? ' (conta verificada)' : ' (conta conectada)' : ' (manual)'}; nenhum email foi enviado nesta etapa.`
...
const MODEL_META: Record<string, { label: string; color: string; bg: string; border: string }> = {
  ...
  'nemotron-super-120b': { label: 'Nemotron Super 120B', color: '#76B900', bg: 'bg-lime-500/10', border: 'border-lime-500/20' },
  'deepseek-v4-pro': { label: 'DeepSeek V4 Pro', color: '#22D3EE', bg: 'bg-cyan-500/10', border: 'border-cyan-500/20' },
  'seed-oss-36b': { label: 'Seed OSS 36B', color: '#14F195', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20' },
  'qwen35-122b': { label: 'Qwen 3.5 122B', color: '#A855F7', bg: 'bg-purple-500/10', border: 'border-purple-500/20' },
  'kimi-k26': { label: 'Kimi K2.6', color: '#60A5FA', bg: 'bg-blue-500/10', border: 'border-blue-500/20' },
  'mixtral-8x22b': { label: 'Mixtral 8x22B', color: '#F59E0B', bg: 'bg-amber-500/10', border: 'border-amber-500/20' },
  'mistral-large': { label: 'Mistral Large 3', color: '#FB7185', bg: 'bg-rose-500/10', border: 'border-rose-500/20' },
  'gpt-oss-120b': { label: 'GPT-OSS 120B', color: '#10B981', bg: 'bg-green-500/10', border: 'border-green-500/20' },
  'gemma4-31b': { label: 'Gemma 4 31B', color: '#F472B6', bg: 'bg-pink-500/10', border: 'border-pink-500/20' },
  'gemma3n-e2b': { label: 'Gemma 3N E2B', color: '#C084FC', bg: 'bg-purple-500/10', border: 'border-purple-500/20' },
  'phi4-mini': { label: 'Phi-4 Mini', color: '#93C5FD', bg: 'bg-sky-500/10', border: 'border-sky-500/20' },
};
...
const CONGCHAIN_MODEL_OPTIONS: Array<{
  ...
  { key: 'nemotron-super-120b', name: 'Nemotron Super', provider: 'NVIDIA NIM', tier: 'open', color: '#76B900', detail: 'High-capacity route for agent planning and broad reasoning.' },
  { key: 'deepseek-v4-pro', name: 'DeepSeek V4', provider: 'NVIDIA NIM', tier: 'open', color: '#22D3EE', detail: 'Protocol reasoning, code review, and technical diagnosis.' },
  { key: 'seed-oss-36b', name: 'Seed OSS', provider: 'NVIDIA NIM', tier: 'open', color: '#14F195', detail: 'Balanced open route for drafting, synthesis, and general answers.' },
  { key: 'qwen35-122b', name: 'Qwen 122B', provider: 'NVIDIA NIM', tier: 'open', color: '#A855F7', detail: 'Long-context coding, repository analysis, and structured outputs.' },
  { key: 'kimi-k26', name: 'Kimi K2.6', provider: 'NVIDIA NIM', tier: 'open', color: '#60A5FA', detail: 'Long-context route for documents, research, and multi-file review.' },
  { key: 'mixtral-8x22b', name: 'Mixtral', provider: 'NVIDIA NIM', tier: 'open', color: '#F59E0B', detail: 'Mixture-of-experts route for flexible reasoning and writing.' },
  { key: 'mistral-large', name: 'Mistral Large', provider: 'NVIDIA NIM', tier: 'open', color: '#FB7185', detail: 'Polished analysis and content route.' },
  { key: 'gpt-oss-120b', name: 'GPT-OSS', provider: 'NVIDIA NIM', tier: 'open', color: '#10B981', detail: 'Heavy open reasoning route for complex plans and verification.' },
  { key: 'gemma4-31b', name: 'Gemma 4', provider: 'NVIDIA NIM', tier: 'open', color: '#F472B6', detail: 'Creative and multilingual route for copy and explanations.' },
  { key: 'gemma3n-e2b', name: 'Gemma 3N', provider: 'NVIDIA NIM', tier: 'open', color: '#C084FC', detail: 'Small fast route for lightweight checks and summaries.' },
  { key: 'phi4-mini', name: 'Phi-4', provider: 'NVIDIA NIM', tier: 'open', color: '#93C5FD', detail: 'Very fast route for intent checks and compact replies.' },
