...
export const MYTHOS_EXTERNAL_CONNECTORS: MythosExternalConnector[] = [
  ...
  },
  {
    ...
    status: hasAnyEnv(['TRANSPARENCIA_API_KEY', 'PORTAL_TRANSPARENCIA_API_KEY']) ? 'ready' : 'needs_key',
  ...
  },
  {
    ...
    domain: 'finance_br',
    status: hasAnyEnv(['BRAPI_API_KEY']) ? 'ready' : 'optional_key',
    envVars: ['BRAPI_API_KEY'],
  ...
  },
  {
    ...
    status: hasAnyEnv(['FRED_API_KEY']) ? 'ready' : 'needs_key',
  ...
  },
  {
    ...
    name: 'Alpha Vantage',
    domain: 'finance_global',
    status: hasAnyEnv(['ALPHA_VANTAGE_API_KEY']) ? 'ready' : 'needs_key',
  ...
  },
  {
    ...
    name: 'Mapbox',
    domain: 'maps',
    status: hasAnyEnv(['MAPBOX_API_KEY', 'MAPBOX_TOKEN']) ? 'ready' : 'needs_key',
  ...
  },
  {
    ...
    name: 'OpenAlex',
    domain: 'science',
    status: hasAnyEnv(['OPENALEX_API_KEY']) ? 'ready' : 'optional_key',
